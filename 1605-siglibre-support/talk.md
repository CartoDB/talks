...
![](resources/platform.png) <!-- .element: style="width:45%;" -->
---
# Support Team
...
![](https://cartodb-libs.global.ssl.fastly.net/cartodb.com/files/img/layout/team/jsanz.b8d1146f.jpg)<!-- .element: style="width:45%;" -->

___

## Madrid (UTC/GMT +2 hours)

![](https://cartodb-libs.global.ssl.fastly.net/cartodb.com/files/img/layout/team/ernesto.bedbe3f7.jpg)<!-- .element: style="width:45%;" -->

___

## Madrid (UTC/GMT +2 hours)

![](https://cartodb-libs.global.ssl.fastly.net/cartodb.com/files/img/layout/team/ramiro/big.680613d4.jpg)<!-- .element: style="width:45%;" -->

___

## Madrid (UTC/GMT +2 hours)

![](https://cartodb-libs.global.ssl.fastly.net/cartodb.com/files/img/layout/team/oriol.e3255871.jpg) <!-- .element: style="width:45%;" -->
...
![](resources/s.png)<!-- .element: style="width:45%;" -->
___

## California (UTC/GMT -7 hours)


![](https://cartodb-libs.global.ssl.fastly.net/cartodb.com/files/img/layout/team/michellec.4a247a08.jpg)<!-- .element: style="width:45%;" -->
...
<img class="noborder" src="resources/support.gif" style="width:50%;">
...
![](resources/slack.png) <!-- .element: style="width:75%;" -->
