...
<span style="vertical-align:middle;display:inline-block;height:250px;">
<img src="http://68.media.tumblr.com/tumblr_m6wgp19eXH1raf61oo1_500.jpg"
   alt="jatorre" style="max-height:250px;">
<span style="vertical-align:middle;height:100%;display:inline-block;margin:0 20px;">&ne;</span>
<img src="http://cartografia.cime.es/documents/documents/710doc5.jpg"
   alt="jsanz" style="max-height:250px;">
</span>
...
> Disciplina que ayuda a convertir <br/>**datos geográficos** en **valor de negocio** mediante su enriquecimiento, visualización y análisis
...
![](imgs/gis-li-2017.png)<!-- .element class="noborder" style="max-height:480px"-->
...
[![](imgs/landscape.png)](http://mattturck.com/wp-content/uploads/2016/03/Big-Data-Landscape-2016-v18-FINAL.png)

---

![](imgs/gis-li-2018.png)<!-- .element class="noborder" style="max-height:480px"-->
...
![](imgs/state-li.png)<!-- .element style="max-height:480px"-->
...
* Mayoría en niveles administrativos <br/> entre **país** y **código postal**
...
![](imgs/strava-banner.jpg)<!-- .element style="width:40%" -->
...
- La mayoría de proveedores de LBS<br/> recogen datos de sus usuarios
- SDK móvil de Mapbox

![](imgs/mapbox-telemetry.png)<!-- .element style="width:50%" -->

---

## Mapbox

![](imgs/mapbox-telemetry2.png)
...
[![](imgs/bcn.png)](http://mwctourism.cartodb.io/index.html?lat=41.398380835943385&lng=2.1636199951171875&zoom=14)
...
[![](imgs/reefers.png)](https://s3-eu-west-1.amazonaws.com/odi-static-projects/illegal-fishing/index.html#9120217/4/-13.75/-35.99)
...
![](imgs/bbva2.png)<!-- .element style="width:55%" -->
...
[![](imgs/gfw-menorca.png)](http://bit.ly/2xWUVkU)
